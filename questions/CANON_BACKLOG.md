...
| api-tokens | — | 🟢 Up to Date | 2026-07-19 | [CANON_OBJECT_Accounts_ApiToken.md](../objects/CANON_OBJECT_Accounts_ApiToken.md) | — |
| buyers | — | 🟢 Up to Date | 2026-07-15 | [CANON_OBJECT_Accounts_Buyer.md](../objects/CANON_OBJECT_Accounts_Buyer.md) | — |
| cloud-tenants | — | 🟢 Up to Date | 2026-07-19 | [CANON_OBJECT_Accounts_CloudTenant.md](../objects/CANON_OBJECT_Accounts_CloudTenant.md) | — |
...
| services | — | 🟢 Up to Date | 2026-07-19 | [CANON_OBJECT_Accounts_Service.md](../objects/CANON_OBJECT_Accounts_Service.md) | — |
...
| Object | Parent | Status | Last Updated | Canon File | Notes |
|--------|--------|--------|--------------|------------|-------|
| event-types | — | 🟡 Known Pending Issues | 2026-07-19 | [CANON_OBJECT_Audit_EventType.md](../objects/CANON_OBJECT_Audit_EventType.md) | Open question AET-002: the update endpoint enforces no actor restriction, diverging from the Operations-curated intent. |
| records | — | 🟢 Up to Date | 2026-07-19 | [CANON_OBJECT_Audit_AuditRecord.md](../objects/CANON_OBJECT_Audit_AuditRecord.md) | — |
...
| Object | Parent | Status | Last Updated | Canon File | Notes |
|--------|--------|--------|--------------|------------|-------|
| credit-memos | — | 🟢 Up to Date | 2026-07-20 | [CANON_OBJECT_Billing_Credit_Memo.md](../objects/CANON_OBJECT_Billing_Credit_Memo.md) | — |
| attachments | credit-memos | 🟡 Known Pending Issues | 2026-07-20 | [CANON_OBJECT_Billing_Credit_Memo_Attachment.md](../objects/CANON_OBJECT_Billing_Credit_Memo_Attachment.md) | Open question CMA-001 (attachment event visibility scope). |
| custom-ledgers | — | 🔴 Not Started | | | |
| attachments | custom-ledgers | 🔴 Not Started | | | |
| invoices | — | 🟢 Up to Date | 2026-07-20 | [CANON_OBJECT_Billing_Invoice.md](../objects/CANON_OBJECT_Billing_Invoice.md) | — |
| attachments | invoices | 🟡 Known Pending Issues | 2026-07-20 | [CANON_OBJECT_Billing_Invoice_Attachment.md](../objects/CANON_OBJECT_Billing_Invoice_Attachment.md) | Open question INA-001 (attachment event visibility scope). |
| journals | — | 🟡 Known Pending Issues | 2026-07-19 | [CANON_OBJECT_Billing_Journal.md](../objects/CANON_OBJECT_Billing_Journal.md) | Open question BJO-005 (possible Operations manual-upload/custom-ledger path). |
| attachments | journals | 🟢 Up to Date | 2026-07-19 | [CANON_OBJECT_Billing_Journal_Attachment.md](../objects/CANON_OBJECT_Billing_Journal_Attachment.md) | — |
| charges | journals | 🟡 Known Pending Issues | 2026-07-19 | [CANON_OBJECT_Billing_Journal_Charge.md](../objects/CANON_OBJECT_Billing_Journal_Charge.md) | Single shared Charge object, also accessed under custom-ledgers, ledgers, and statements. Open question CHG-001 (Consolidated billing type origin). |
| ledgers | — | 🟢 Up to Date | 2026-07-19 | [CANON_OBJECT_Billing_Ledger.md](../objects/CANON_OBJECT_Billing_Ledger.md) | — |
| attachments | ledgers | 🟢 Up to Date | 2026-07-19 | [CANON_OBJECT_Billing_Ledger_Attachment.md](../objects/CANON_OBJECT_Billing_Ledger_Attachment.md) | — |
| manual-overrides | — | 🔴 Not Started | | | |
| statements | — | 🟡 Known Pending Issues | 2026-07-20 | [CANON_OBJECT_Billing_Statement.md](../objects/CANON_OBJECT_Billing_Statement.md) | Open question SOM-003 (no confirmed removal path for a Manual or Consolidated Statement). |
| attachments | statements | 🟡 Known Pending Issues | 2026-07-20 | [CANON_OBJECT_Billing_Statement_Attachment.md](../objects/CANON_OBJECT_Billing_Statement_Attachment.md) | Open question STA-001 (attachment event visibility scope). |
...
|---------|------|--------|-------|
| 4.42 | 2026-07-20 | Stu / canon-generate-batch | Billing batch #4 (4 objects) drafted via canon-generate-batch — PROD evidence (same sensitive client; Credit Memo/attachment fetched cross-tenant via Operations as ours is client-scoped; IDs kept out of the repo), mpt-billing source research, the Invoices & Credit Memos + Invoice Samples Confluence pages, and the batch's own source dig. Fresh drafts: **Invoice** (INV — MPT representation of an ERP invoice, synced 1:1 with the NAV invoice and linked to a Debit Statement; ERP-synced read object, no state machine, Operations-only bulk-upsert write, no delete; 0 open questions), **Invoice Attachment** (INA — stateless file, Client-readable for own Invoices + Operations, mutation Operations-only; carries the auto-generated Output ERP PDF (external, live-fetched) or a manual Attachment; 1 open question INA-001), **Credit Memo** (CRD — negative-amount counterpart of Invoice, single status Issued, ERP-synced, no delete, permanent retention; 0 open questions), **Credit Memo Attachment** (CMA — parallel to Invoice Attachment; 1 open question CMA-001). Resolved during review: status is unsequenced/ERP-authoritative, best-effort Statement linkage, Credit-type and line/header reconciliation trusted to ERP, permanent retention — all intended. Preamble §5.3 INV/INA/CRD/CMA added (v2.17). Correction to already-merged canon: Statement Attachment reframed to document delete as Operations-only by design, removing an earlier implementation caveat and its open question. Exclusions for invoice/credit-memo shared charges/attachments views. Drift baselines recorded (PROD spec). Co-promotion: Invoice/Credit Memo ↔ Statement cross-links to bracket at promotion; also fixed a malformed merged changelog row (4.41/4.40). |
| 4.41 | 2026-07-20 | Stu / canon-generate-batch | Billing batch #3 (2 objects) drafted via canon-generate-batch — PROD multi-Actor evidence (same sensitive client; IDs kept out of the repo), mpt-billing source research, the two Statement Confluence pages, and an Opus authorization/event dig. Fresh drafts: **Statement** (SOM — client-facing per-Agreement billing document generated from a Ledger; 9-state machine Generated/Cancelled/Queued/Pending/Issued/Error/Generating/Consolidating/Consolidated; three billing types Automated/Manual/Consolidated; Debit/Credit by net total → ERP Sales Order/Invoice or Credit Memo; Operations-only actions with Client-readable GETs; consolidation add/remove-child grouping; 1 open question SOM-003), **Statement Attachment** (STA — stateless file readable by Client+Operations, mutation intended Operations-only; only Attachment type occurs; 2 open questions STA-001/STA-002). Resolved during review: retry→Queued (stale API description), intercompany = Authorization owner's Seller ≠ Licensee's Seller (ERP-layer). Preamble §5.3 SOM/STA added and Invariant 6 Journal-reset cascade exception recorded (v2.16). Exclusions for the statement action verbs + shared statement.charges view. Drift baselines recorded (PROD spec). Co-promotion: Statement ↔ Ledger/Journal/Charge cross-links and stale-note cleanup, plus Statement ↔ Statement Attachment, to bracket at promotion. |
| 4.40 | 2026-07-19 | Stu / canon-generate-batch | Billing batch #2 (2 objects) drafted via canon-generate-batch — PROD multi-Actor evidence (same sensitive client as the Journal batch; IDs kept out of the repo), mpt-billing source research, the "Ledger format" + billing Confluence pages, and an Opus finding. Fresh drafts: **Ledger** (BLE — top-level per-Seller rating output between Journal and Statement; 7-state machine Review/Error/Rating/Generating/Generated/Queued/Completed; generated one-per-Seller on Journal accept, never created/deleted via API, Operations-only read, accept creates Statements, queue pushes ERP, automatic roll-up to Completed drives the parent Journal; 0 open questions), **Ledger Attachment** (LEA — stateless Operations-only CRUD file; only the general Attachment type occurs on a Ledger so no deletion guard applies; soft-delete retains metadata; 0 open questions). Preamble §5.3 BLE/LEA added (v2.15). Exclusions for the ledger action verbs + the shared ledger.charges view. Drift baselines recorded (PROD spec). New objects surfaced: **Statement** (next pipeline object) and **Custom Ledger** (a distinct Operations manual-upload billing object — almost certainly the object behind Journal open question BJO-005). Co-promotion: Journal ↔ Ledger cross-links (and Ledger ↔ Ledger Attachment) to bracket at promotion; the Journal canon's plain 'Ledger' mentions get bracketed and its BJO-005 annotated with the Custom Ledger lead. |
| 4.39 | 2026-07-19 | Stu / canon-generate-batch | Billing batch (3 objects) drafted via canon-generate-batch — **PROD** multi-Actor evidence (a real, sensitive client; IDs kept out of the repo), source research over the dedicated `mpt-billing` service, five business-context Confluence pages, and an Opus source dig. Fresh drafts: **Journal** (BJO — Vendor-submitted normalized billing data; 14-state pipeline Draft→…→Generated→Accepted→Queued→Completed; Vendor creates/submits, Operations reviews/accepts; never client-readable; delete removes child Charges/Attachments; 1 open question BJO-005), **Charge** (CHG — child, platform-generated, read-only + Ops-only match/ignore/reset reconciliation; dual per-Actor status; auto-splits parent→child on active split billing; confidential sell-side pricing vendor-hidden; 1 open question CHG-001), **Journal Attachment** (JOA — stateless CRUD file, Vendor/Operations only, Attachment/Input types with Input deletion-guarded, soft-delete retains metadata, 500 MB cap; 0 open questions). Preamble §5.3 BJO/CHG/JOA added and Invariant 6 delete-cascade exception recorded (v2.14). Exclusions added for the journal/charge action verbs. Drift baselines recorded. New billing objects surfaced for future runs: Ledger, Statement, Manual Upload, Custom Ledger. Co-promotion cross-links Journal ↔ Charge ↔ Attachment to bracket at promotion. |
