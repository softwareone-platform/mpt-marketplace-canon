...
| split | subscriptions | 🔴 Not Started | | | Split Billing — confirmed a real object with its own endpoints (`/split`: GET/PUT), not just a field. Subscription-side fields documented in Commerce: Subscription canon BR-015. |
