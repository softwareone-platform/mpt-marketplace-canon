...
| attachments | statements | 🟡 Known Pending Issues | 2026-07-20 | [CANON_OBJECT_Billing_Statement_Attachment.md](../objects/CANON_OBJECT_Billing_Statement_Attachment.md) | Open questions STA-001 (attachment event visibility scope) and STA-002 (Client-delete not enforced Operations-only; systemic across Invoice/Credit Memo attachments). |
