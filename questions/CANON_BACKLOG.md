...
| products | — | 🟢 Up to Date | 2026-07-15 | [CANON_OBJECT_Catalog_Product.md](../objects/CANON_OBJECT_Catalog_Product.md) | |
| documents | products | 🔴 Not Started | | | |
| item-groups | products | 🟡 Known Pending Issues | 2026-03-14 | [CANON_OBJECT_Catalog_Product_ItemGroup.md](../objects/CANON_OBJECT_Catalog_Product_ItemGroup.md) | Not yet re-verified via canon-generate. |
| items | products | 🟡 Known Pending Issues | 2026-03-14 | [CANON_OBJECT_Catalog_Product_Item.md](../objects/CANON_OBJECT_Catalog_Product_Item.md) | Not yet re-verified via canon-generate. |
| media | products | 🟡 Known Pending Issues | 2026-03-14 | [CANON_OBJECT_Catalog_Product_Media.md](../objects/CANON_OBJECT_Catalog_Product_Media.md) | Not yet re-verified via canon-generate. |
| parameter-groups | products | 🟡 Known Pending Issues | 2026-03-14 | [CANON_OBJECT_Catalog_Product_ParameterGroup.md](../objects/CANON_OBJECT_Catalog_Product_ParameterGroup.md) | Not yet re-verified via canon-generate. |
| parameters | products | 🟡 Known Pending Issues | 2026-03-14 | [CANON_OBJECT_Catalog_Product_Parameter.md](../objects/CANON_OBJECT_Catalog_Product_Parameter.md) | Not yet re-verified via canon-generate. |
