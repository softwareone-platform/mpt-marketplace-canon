...
| parameter-groups | products | 🟡 Known Pending Issues | 2026-07-15 | [CANON_OBJECT_Catalog_Product_ParameterGroup.md](../objects/CANON_OBJECT_Catalog_Product_ParameterGroup.md) | One error corrected (Default Group auto-assignment claim, found via the Parameter canon refresh) — not a full canon-generate pass. Still not fully re-verified. |
