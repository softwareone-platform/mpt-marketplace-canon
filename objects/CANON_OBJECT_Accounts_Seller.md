...
| Accounts: Licensee | Association | One:Many | A Licensee is related to exactly one Seller. | Any Licensee related to this Seller currently in `Active` or `Enabled` status blocks Activate, Disable, Deactivate, and Delete on this Seller (BR-007). |
...
| --- | --- | --- | --- |
| 0.7 | 2026-07-16 | Stu / canon-generate | Accounts: Licensee now canonised — bracketed the `[[Licensee]]` cross-references (BR-007, Section 7.2, Section 8) and removed the stale "not yet canonised" notes (BR-007, Section 6). No behavioural change. Surfaced while canonising Accounts: Licensee. |
