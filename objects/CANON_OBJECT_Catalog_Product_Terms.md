...
| T6 | Draft | Deleted | Delete | Vendor | Terms must be in Draft state. All child Variants must be deleted first. | Permanently removed — no longer retrievable via the API. |
