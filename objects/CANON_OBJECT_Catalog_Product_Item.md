...
| T2 | Draft | Pending | Submit for publishing | Vendor | None | Item awaiting Operations review. |
| T3 | Pending | Published | Approve and publish | Operations | None | Item available for inclusion in Price Lists and ordering by Clients. |
| T4 | Published | Unpublished | Unpublish | Vendor, Operations | None | Item withdrawn from Client visibility. |
| T5 | Unpublished | Published | Re-publish | Operations | None | Item restored to Client visibility. |
| T6 | Draft | Deleted | Delete | Vendor | Item must be in Draft state | Permanently removed — no longer retrievable via the API. |
