...
| BR-017 | A Client Account's Buyers are held via a direct reference on each Buyer (not mediated by ErpLink). This differs from the Accounts: Seller relationship to Buyers, which is mediated by ErpLink. | All | All | — |
