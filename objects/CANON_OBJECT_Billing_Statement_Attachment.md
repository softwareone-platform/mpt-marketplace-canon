...
| Client     | No | Yes | No | No | Read-only by design — every Statement Attachment mutation is Operations-only (BR-004). |
...
| BR-004 | Every Statement Attachment mutation — create, update, and delete — is restricted to the Operations Actor; the Client and Operations Actors may only read. | N/A | Operations (mutation); Client, Operations (read) | — |
