...
| T2 | None / Inactive | Active | Activate | Operations | None | Yield cap begins being observed on matching Orders during Order creation. |
| T3 | Active | Inactive | Disable | Operations | None | Yield cap no longer observed on new Orders. Existing Orders unaffected. |
| T4 | Any | Deleted | Delete | Operations | None | Soft delete. Policy remains retrievable via the API. |
